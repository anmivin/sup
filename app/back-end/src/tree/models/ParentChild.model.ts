...
export interface ParentChildModelCreate extends Omit<ParentChildModel, keyof Model | 'parent' | 'child'> {}
@Table({ tableName: 'parent_child', underscored: true, timestamps: false })
export class ParentChildModel extends Model<ParentChildModel, ParentChildModelCreate> {
  @PrimaryKey
  @Column
  declare id: string;
